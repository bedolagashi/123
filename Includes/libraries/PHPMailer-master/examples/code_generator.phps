    ...
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        switch ($_POST['test_type']) {
            case 'smtp':
                ...
                $mail->Port = (integer)$_POST['smtp_port']; 
                if ($_POST['smtp_secure']) {
                    $mail->SMTPSecure = strtolower($_POST['smtp_secure']);
                }
                $mail->SMTPAuth = array_key_exists('smtp_authenticate', $_POST); 
        ...
        $mail->addAttachment('images/phpmailer_mini.png', 'phpmailer_mini.png'); 
        $mail->addAttachment('images/phpmailer.png', 'phpmailer.png'); 
