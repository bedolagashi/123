    	...
    	?>
                    ...
                    <div class="panel panel-green ">
                        ...
                        <a href="clients.php">
                            <div class="panel-footer">
                                <span class="pull-left">Просмотреть подробную информацию</span>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-right">
                                    ...
                                    <div>Общее количество назначений</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
            ...
            <div class="card">
                ...
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_orders active" onclick="openTab(event, 'recent_orders','tabcontent_orders','tablinks_orders')">Последние заказы</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'completed_orders','tabcontent_orders','tablinks_orders')">Выполненные заказы</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'canceled_orders','tabcontent_orders','tablinks_orders')">Отмененные заказы</button>
                </div>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Сведения о клиенте</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <ul>
                                                                            <li><span style="font-weight: bold;">Полное имя: </span> <?php echo $order['client_name']; ?></li>
                                                                            <li><span style="font-weight: bold;">Номер телефона: </span><?php echo $order['client_phone']; ?></li>
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip" title="Deliver Order">
                                                            ...
                                                            <div class="modal fade" id="<?php echo $deliver_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $deliver_data; ?>" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Доставить заказ</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip" title="Cancel Order">
                                                            ...
                                                            <div class="modal fade" id="<?php echo $cancel_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $cancel_data; ?>" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Отменить заказ</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
