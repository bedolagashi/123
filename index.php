...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
						Итальянская пицца с помидорами черри и зеленым базиликом
						</p>
	...
	<section class="our_menus" id="menus">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">ОЗНАКОМЬТЕСЬ С НАШИМ МЕНЮ</h2>
	...
	<section class="image-gallery" id="gallery">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">ГАЛЕРЕЯ ИЗОБРАЖЕНИЙ</h2>
			<?php
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
						Saasbiz - это другой вид архитектурной практики. Основанная компанией LoganCee в 1991 году, мы являемся фирмой, принадлежащей сотрудникам, придерживающейся демократичного процесса проектирования, в котором ценится вклад каждого.
                        </p>
                        <h3>
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="contact-form">
                        <div id="contact_ajax_form" class="contactForm">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button id="contact_send" class="bttn_style_2">Отправить сообщение</button>
                                </div>
                            </div>
                            <div id="sending_load" style="display: none;">Отправляется...</div>
				...
				<div class="col-md-4" style="padding: 10px;">
					<div class="quality quality_1">
						<div class="text_inside_quality">
							<h5>Качественные продукты питания</h5>
						</div>
					</div>
				</div>
				<div class="col-md-4" style="padding: 10px;">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <p>
						Наш ресторан - один из лучших, предлагает вкусные меню и блюда. Вы можете забронировать столик или заказать еду.
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Понедельник - пятница с 11:00 до 21:00</li>
                            <li>Понедельник - пятница с 11:00 до 21:00</li>
                            <li>Понедельник - пятница с 11:00 до 21:00</li>
                            <li>Понедельник - пятница с 11:00 до 21:00</li>
                        </ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <h3>Подпишитесь на наш контент</h3>
