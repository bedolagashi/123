                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <div id = 'required_category_name' class="invalid-feedback">
                                            <div>Требуется название категории!</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                    <button type="button" class="btn btn-info" id="add_category_bttn">Добавить категорию</button>
                                </div>
                            </div>
                        </div>
                    </div>
		                                                    ...
		                                                    <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
		                                                        <div class="modal-dialog" role="document">
		                                                            <div class="modal-content">
		                                                                ...
		                                                                <div class="modal-body">
                                                                        Вы уверены, что хотите удалить эту категорию?<?php echo strtoupper($category['category_name']); ?>"?
		                                                                </div>
		                                                                <div class="modal-footer">
		                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
		                                                                    <button type="button" data-id = "<?php echo $category['category_id']; ?>" class="btn btn-danger delete_category_bttn">Удалить</button>
		                                                                </div>
		                                                            </div>
		                                                        </div>
		                                                    </div>
