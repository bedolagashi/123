                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Удалить меню</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                            Вы уверены, что хотите удалить это меню?<?php echo strtoupper($menu['menu_name']); ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                                                <button type="button" data-id = "<?php echo $menu['menu_id']; ?>" class="btn btn-danger delete_menu_bttn">Удалить</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="panel-X">
                                    ...
                                    <div class="save-header-X">
                                        <div style="display:flex">
                                            ...
                                            <div class="title-container">Подробности меню</div>
                                        </div>
                                        <div class="button-controls">
                                            <button type="submit" name="add_new_menu" class="btn btn-primary">Сохранить</button>
                                        </div>
                                    </div>
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label for="menu_category">Категория меню</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_description">Описание меню</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']))
                                                {
                                                    ...
                                                    elseif(strlen(test_input($_POST['menu_description'])) > 200)
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                            Длина описания должна составлять менее 200 букв
                                                            </div>
                                                        <?php
                                        ...
                                        <div class="form-group">
                                            <label for="menu_price">Цена меню($)</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_image">Изображение меню</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST')
                                                {
                                                    ...
                                                    if(!empty($_FILES['menu_image']['name']) && !in_array($image_extension,$image_allowed_extension))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                            Недопустимый формат изображения. Принимаются только форматы JPEG, JPG и PNG!
                                                            </div>
                                                        <?php
                                ...
                                <form method="POST" class="menu_form" action="menus.php?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                                    <div class="panel-X">
                                        ...
                                        <div class="save-header-X">
                                            ...
                                            <div class="button-controls">
                                                <button type="submit" name="edit_menu_sbmt" class="btn btn-primary">Сохранить</button>
                                            </div>
                                        </div>
                                        <div class="panel-body-X">
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['edit_menu_sbmt']))
                                                    {
                                                        if(empty(test_input($_POST['menu_price'])))
                                                        {
                                                            ?>
                                                                <div class="invalid-feedback" style="display: block;">
                                                                требуется цена по прейскуранту.
                                                                </div>
                                                            <?php
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['edit_menu_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST')
                                                    {
                                                        ...
                                                        if(!empty($_FILES['menu_image']['name']) && !in_array($image_extension,$image_allowed_extension))
                                                        {
                                                            ?>
                                                                <div class="invalid-feedback" style="display: block;">
                                                                Недопустимый формат изображения. Принимаются только JPEG, JPG и PNG-файлы!
                                                                </div>
                                                            <?php
