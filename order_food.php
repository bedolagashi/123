		...
		<form method="post" id="order_food_form" action="order_food.php">
				                                    	...
				                                    	<div class="select_item_bttn">
				                                    		<div class="btn-group-toggle" data-toggle="buttons">
																<label class="menu_label item_label btn btn-secondary">
																	<input type="checkbox"  name="selected_menus[]" value="<?php echo $row['menu_id'] ?>" autocomplete="off">Выбрать
																</label>
															</div>
				                                    	</div>
				                                    <?php
            ...
            <div style="overflow:auto;padding: 30px;">
                <div style="float:right;">
                    ...
                    <button type="button" class="next_prev_buttons" style="background-color: #bbbbbb;"  id="prevBtn"  onclick="nextPrev(-1)">Предыдущий</button>
                    <button type="button" id="nextBtn" class="next_prev_buttons" onclick="nextPrev(1)">Следующий</button>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Штаб-квартира</h3>
                        <p>
                        Пятая авеню, 962, 3-й этаж, Нью-Йорк, NY10022
                        </p>
                        <p>
                    ...
                    <div class="footer_widget">
                        ...
                        <div class="subscribe_form">
                            <form action="#" class="subscribe_form" novalidate="true">
                                ...
                                <button type="submit" class="submit">Подпишись</button>
