        ...
        ?>
            ...
            <form method="POST" action="table-reservation.php">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="number_of_guests">Сколько людей?</label>
                            <select class="form-control" name="number_of_guests">
                                <option value="1" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>
                                    Один человек
                                </option>
                                <option value="2" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>2 человека</option>
                                <option value="3" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>3 человека</option>
                                <option value="4" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>4 человека</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
